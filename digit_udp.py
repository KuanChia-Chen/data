...
from util.mimic_evaluation_factory import mimic_control, receive_internet
import threading
import socket
import json
...
async def run(actor, env: GenericEnv, do_log = True, pol_name = "test"):
    ...
    global log_ind, log_hf_ind, part_num, movement_data, received_data
